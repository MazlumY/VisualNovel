...
(function (Endabgabe) {
    async function Dorf() {
        ...
        console.log("Location shown");
        Endabgabe.fS.Sound.fade(Endabgabe.sound.jungle, 0, 0);
        Endabgabe.fS.Sound.fade(Endabgabe.sound.dorf, 0.3, 0.15);
        await Endabgabe.fS.Character.show(Endabgabe.characters.Narrator, Endabgabe.characters.Narrator.pose.neutral, Endabgabe.fS.positions.bottomcenter);
        console.log("Character shown");
        await Endabgabe.fS.update();
        console.log("FS Updated");
...
(function (Endabgabe) {
    async function FlugZeug() {
        Endabgabe.fS.Sound.fade(Endabgabe.sound.jungle, 0, 0);
        Endabgabe.fS.Sound.fade(Endabgabe.sound.dorf, 0, 0);
        Endabgabe.tookItem = 0;
        Endabgabe.versuche++;
...
(function (Endabgabe) {
    async function InselAnfang() {
        ...
        await Endabgabe.fS.Location.show(Endabgabe.location.InselAnfang);
        console.log("Location shown");
        Endabgabe.fS.Sound.play(Endabgabe.sound.jungle, 0.3, true);
        await Endabgabe.fS.Character.show(Endabgabe.characters.Narrator, Endabgabe.characters.Narrator.pose.neutral, Endabgabe.fS.positions.bottomcenter);
        console.log("Character shown");
        await Endabgabe.fS.update();
        console.log("FS Updated");
        ...
        switch (userInput) {
            case choose.C0001:
                ...
                if (Endabgabe.tookItem == 1) {
                    ...
                    await Endabgabe.fS.Character.hide(Endabgabe.characters.Narrator);
                    await Endabgabe.fS.Character.show(Endabgabe.characters.Ureinwohner, Endabgabe.characters.Ureinwohner.pose.neutral, Endabgabe.fS.positions.bottomright);
                    await Endabgabe.fS.Character.show(Endabgabe.characters.Narrator, Endabgabe.characters.Narrator.pose.neutral, Endabgabe.fS.positions.bottomleft);
                    ...
                    await Endabgabe.fS.Character.hide(Endabgabe.characters.Ureinwohner);
                    await Endabgabe.fS.Speech.tell(Endabgabe.characters.Narrator, text.Narrator.T0004);
                    await Endabgabe.fS.update();
                    await Endabgabe.fS.Speech.tell(Endabgabe.characters.Narrator, text.Narrator.T0005);
                    await Endabgabe.fS.update();
