namespace Endabgabe {
    export async function InselAnfang(): fS.SceneReturn {
        let text = {
          ...
          fS.Sound.play(sound.jungle, 0.3, true);
          ...
          switch (userInput) {
            ...
            fS.Sound.play(sound.click, 0.3, false);
              if (tookItem == 1) {
                ...
                await fS.Character.show(characters.Ureinwohner, characters.Ureinwohner.pose.neutral, fS.positions.bottomright);
                await fS.Character.show(characters.Narrator, characters.Narrator.pose.neutral, fS.positions.bottomleft);
                ...
                await fS.Character.hide(characters.Ureinwohner);
